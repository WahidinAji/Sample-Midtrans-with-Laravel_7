...
class PaymentMidtransController extends Controller
{
    public function notification(Request $request)
    {
        ...
        if ($transaction == 'capture') {
            ...
            if ($type == 'credit_card') {
                if ($fraud == 'challenge') {
                    $transaction = PaymentMidtrans::CHALLENGE;
                    ...
                    $transaction = PaymentMidtrans::SUCCESS;
                    $join->payment_due = $notif->transaction_time;
                    $join->payment_type = $type;
            ...
            $transaction = PaymentMidtrans::SETTLEMENT;
            $join->payment_due = $notif->transaction_time;
            $join->payment_type = $type;
            ...
            $transaction = PaymentMidtrans::PENDING;
            $join->payment_due = $notif->transaction_time;
            $join->payment_type = $type;
            ...
            $transaction = PaymentMidtrans::DENY;
            $join->payment_due = $notif->transaction_time;
            $join->payment_type = $type;
        ...
        $payment_midtrans = new PaymentMidtrans;
